...
const config: Config = {
  title: 'Firnas',
  tagline: 'An Arabic Programming Language',
  ...
  organizationName: 'firnas-lang', // Usually your GitHub org/user name.
  projectName: 'www-firnas-lang', // Usually your repo name.
  ...
  themeConfig: {
    ...
    image: 'img/firnas-social-card.jpeg',
    navbar: {
      title: 'Firnas',
      logo: {
        alt: 'Firnas Logo',
